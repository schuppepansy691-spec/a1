$baseDir = "d:\antigravity website\jacketdistrict"

Write-Host "=========================================" -ForegroundColor Cyan
Write-Host "    JACKETDISTRICT - AUDIT REPORT        " -ForegroundColor Cyan
Write-Host "=========================================" -ForegroundColor Cyan
...
if ($indexContent -match "blog-jacket-card" -or $indexContent -match "blog-jacket-grid") {
...
Write-Host "`nJacketDistrict Audit Completed Successfully." -ForegroundColor Cyan